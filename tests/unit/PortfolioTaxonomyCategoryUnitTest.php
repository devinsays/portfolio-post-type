...
class PortfolioTaxonomyCategoryUnitTest extends WP_UnitTestCase {
	...
	public function setUp() {
		parent::setUp();
		$this->object = new Portfolio_Post_Type_Taxonomy_Category;
	...
	private function get_default_args() {
		$method = new ReflectionMethod(	'Portfolio_Post_Type_Taxonomy_Category', 'default_args' );
